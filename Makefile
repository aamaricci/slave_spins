...
OBJS= SS_VARS_GLOBAL.o SS_INPUT_VARS.o SS_SETUP.o SLAVE_SPINS.o
#   ED_AUX_FUNX.o ED_IO.o ED_SETUP.o ED_EIGENSPACE.o ED_BATH.o ED_BATH_FUNCTIONS.o ED_HAMILTONIAN_MATVEC.o  ED_DIAG.o ED_OBSERVABLES.o ED_GREENS_FUNCTIONS.o ED_CHI_FUNCTIONS.o ED_CHI2FIT.o  ED_MAIN.o
